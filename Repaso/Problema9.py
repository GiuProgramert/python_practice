# n = int(input("Introduzca la cantidad N de estudiantes: "))
# p = int(input("Introduzca la cantidad P de alumnos por grupo: "))

# alumnos = []
# suma_calificaciones = 0
# for i in range(n):
#   codigo = int(input("Introduzca el código de alumno: "))
#   calificacion = int(input("Introduzca la calificación del alumnos: "))
...
puntaje_separar = suma_calificaciones / ((n + 1) / p)
RES = []
...
if p == 2:
  ...
  for i in range(0, n * 2 - 2, 2):
    for j in range(i + 2, n * 2 - 1, 2):
      for z in range(j + 2, n * 2, 2):
        suma = alumnos[i + 1] + alumnos[j + 1] + alumnos[z + 1]
        print(alumnos[i + 1], alumnos[j + 1], alumnos[z + 1])
        if suma == puntaje_separar:
          RES.append(alumnos[i])
          RES.append(alumnos[j])
